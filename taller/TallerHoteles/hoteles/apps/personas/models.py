...
class Reserva(models.Model):
    ...
    fechaingresoReserva = models.CharField(max_length=100, help_text="Ingrese la fecha de ingreso")
    fechasalidaReserva  = models.CharField(max_length=100, help_text="Ingrese la fecha de salida")
